/** the purpose of this example applet it to draw a boxy car 
 * out of basic graphical shapes (rectangles, circles and lines) on the applet window.
 * It's position and size has been predetermined by 
 * sketching it out on graph paper first. 
 * The specific values of the coordinates
...
public class CarDrawer extends Applet { 
	...
	g2.draw(body);
	g2.draw(frontTire);
	g2.draw(rearTire); g2.draw(frontWindshield); g2.draw(roofTop); g2.draw(rearWindshield);
	// draw the label under the car
	g2.drawString("UT JavaMobile 1.2", 100, 150); 
	} // end of paint*/
} // end of CarDrawer
